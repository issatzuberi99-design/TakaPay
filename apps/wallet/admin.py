...
class WalletTransactionAdmin(admin.ModelAdmin):
    list_display = (
        "wallet_user", "transaction_type", "amount", "description", "reference", "collection", "created_at",
    )
    ...
    readonly_fields = (
        "wallet", "transaction_type", "amount", "description", "reference", "collection", "created_at",
    )
